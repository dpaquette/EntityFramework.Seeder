...
{
    [Story(AsA = "developer",
        IWant = "load a list of countries from a file",
        SoThat = "I do not need to enter it manually")]
    public class when_seeding_an_empty_db_set_from_a_file : Scenario
    {
        ...
        {
            _context.Countries.SeedFromFile("CountriesFile.csv", c => c.Code);
